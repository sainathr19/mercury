...
export const RECEIVE_NETWORKS: ReceiveNetwork[] = [
  ...
  { key: 'base', name: 'Base', kind: 'address', addrKey: 'eth', coingeckoId: 'base', symbol: 'BASE', colorHex: '#0052FF', uriScheme: 'ethereum' },
  ...
  { key: 'tempo', name: 'Tempo', kind: 'address', addrKey: 'eth', coingeckoId: 'tempo', symbol: 'USD', colorHex: '#1C1C1E', uriScheme: 'ethereum' },
];
